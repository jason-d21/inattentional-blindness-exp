Public Class LowLoad
    ...
    Private Sub LowLoad_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        o1.Hide()
        o2.Hide()
        o3.Hide()
        o4.Hide()
    ...
    Private Sub Start_KeyDown(sender As Object, e As KeyEventArgs) Handles StartButton.KeyDown
        If e.KeyCode = Keys.Up And TrackSoundID.Enabled = True And GlobalVariables.TrialNumber < 8 Then
            ...
            If GlobalVariables.TrialNumber = 7 Then
    ...
    Private Sub Timer11_Tick(sender As Object, e As EventArgs) Handles Timer11.Tick
        If GlobalVariables.TrialNumber = 7 Or GlobalVariables.TrialNumber = 8 Then
    ...
    Private Sub Timer55_Tick(sender As Object, e As EventArgs) Handles Timer55.Tick
        ...
        StartButton.Show()
        TrackSoundID.Stop()
        If GlobalVariables.LetterID = "X" Then
            ...
            End If
        ElseIf GlobalVariables.LetterID = "N" Then
    ...
    Private Sub Result_DoubleClick(sender As Object, e As EventArgs) Handles Result.MouseDoubleClick
        ...
        End If
        StartButton.Hide()
        SoundCount.Text = "False ID = " & GlobalVariables.SoundID - GlobalVariables.CorrectSoundID & "; " & "Correct ID: " & Text & "; " & "Trial Number: " & GlobalVariables.TrialNumber
        SoundCount.Show()
        CloseButton.Show()
